...
class SendPhoneModel : NSObject, NSCoding{

	var code : String!
	var data : SendPhoneData!
	var flag : String!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		if let dataData = dictionary["data"] as? NSDictionary{
			data = SendPhoneData(fromDictionary: dataData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         data = aDecoder.decodeObjectForKey("data") as? SendPhoneData
