...
class TodayDongdouModel : NSObject, NSCoding{

	var code : String!
	var data : TodayDongdouData!
	var flag : String!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		if let dataData = dictionary["data"] as? NSDictionary{
			data = TodayDongdouData(fromDictionary: dataData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         data = aDecoder.decodeObjectForKey("data") as? TodayDongdouData
