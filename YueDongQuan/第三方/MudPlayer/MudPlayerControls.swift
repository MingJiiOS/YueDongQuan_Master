...
class MudPlayerControls: UIView {
    ...
    */
    ...
    private func setupView() {
        ...
        self.playButton.addTarget(self, action: #selector(MudPlayerControls.buttonAction(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.progressSlider.addTarget(self, action: #selector(MudPlayerControls.sliderDragCancelAction(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        self.progressSlider.addTarget(self, action: #selector(MudPlayerControls.sliderDragCancelAction(_:)), forControlEvents: UIControlEvents.TouchUpOutside)
        self.progressSlider.addTarget(self, action: #selector(MudPlayerControls.sliderDragAction(_:)), forControlEvents: UIControlEvents.ValueChanged)
        ...
        self.closeButton.addTarget(self, action: #selector(MudPlayerControls.buttonAction(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.grayPlayButton.addTarget(self, action: #selector(MudPlayerControls.buttonAction(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        NSTimer.scheduledTimerWithTimeInterval(1, target: self, selector: #selector(MudPlayerControls.checkNeedHidden(_:)), userInfo: nil, repeats: true)
        
        let tapGesture = UITapGestureRecognizer()
        tapGesture.addTarget(self, action: #selector(MudPlayerControls.show))
