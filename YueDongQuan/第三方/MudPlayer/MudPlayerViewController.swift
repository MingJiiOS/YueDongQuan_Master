...
//        UIApplication.sharedApplication().keyWindow?.windowLevel = UIWindowLevelNormal
    ...
    private func addObserverForPlayer() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(MudPlayerViewContoller.handNotification(_:)), name: AVPlayerItemDidPlayToEndTimeNotification, object: nil)
