...
class HeFoundData : NSObject, NSCoding{

	var array : [HeFoundArray]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		if let arrayArray = dictionary["array"] as? [NSDictionary]{
			for dic in arrayArray{
				let value = HeFoundArray(fromDictionary: dic)
				array.append(value)
			}
		}
	}
    ...
    */
	...
	{
         array = aDecoder.decodeObjectForKey("array") as? [HeFoundArray]
