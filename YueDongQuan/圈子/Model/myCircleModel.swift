...
class myCircleModel : NSObject, NSCoding{

	var code : String!
	var data : myCircleData!
	var flag : String!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		if let dataData = dictionary["data"] as? NSDictionary{
			data = myCircleData(fromDictionary: dataData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         data = aDecoder.decodeObjectForKey("data") as? myCircleData
